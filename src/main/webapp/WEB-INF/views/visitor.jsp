...
<div class="container">
  ...
  <div class="text-center">
    <a class="btn btn-default" href="<c:url value="/user/mypage" />" role="button">마이페이지</a>
    <a class="btn btn-default" href="<c:url value="/user/signout" />" role="button">로그아웃</a>
  </div>
